...
int main(int argc, char **argv){
 ...
 printf("\n\n");
printf("=============================================\n");
printf(" Poker Game  - Development Version\n");
printf(" Phase 1: Game Engine Implementation\n");
printf(" Phase 2: Monte Carlo AI (In Progress)\n");
printf("=============================================\n\n");

printf("========[Welcome to Five Card Monte Carlo Poker]========\n\n");
	  ...
	  *maxvalue=0;
	  ...
	  if(i==HUMANPLAYER){
		...
		maxcumulbet = abet+players[i]->bet;
	      ...
	      if(*maxthrown==0)   
		printf("\nThe advisor says: AI advisor module under development.\n");
	      else{
		if(*maxthrown==1) 
		  printf("\nThe advisor says: AI Advisor in Progress.\n");
		else              
		  printf("\nThe advisor says: AI Advisor in Progress.\n");
